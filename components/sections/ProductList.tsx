      ...
      <div className="relative max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-stone-500 dark:text-[#fbf7f0]/60 mt-5 max-w-xl mx-auto leading-relaxed">
            Potongan daging babi pilihan yang diproses setiap subuh dan siap dikirim ke rumah Anda.
          </p>
        </div>
              ...
              <div className="flex flex-col flex-1 p-6">
                ...
                <div className="flex flex-wrap gap-1.5 mt-4">
                  {p.cookingSuggestions.slice(0, 3).map((s, j) => (
                    <span key={j} className="text-[10px] px-2 py-0.5 rounded-full bg-stone-100 dark:bg-[#2a2a2a] text-stone-500 dark:text-[#a8a29e] border border-stone-200 dark:border-[#383838]">
                      {s}
                    </span>
                  ))}
                </div>
                ...
                <div className="mt-5 flex items-end justify-between">
                  <div>
                    ...
                    <div className="text-stone-400 dark:text-[#fbf7f0]/40 text-xs mt-0.5">{p.unit}</div>
                  </div>
                  <Link
                    href={`/produk/${p.slug}`}
