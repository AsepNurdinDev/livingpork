...
const steps = [
  {
    ...
    icon: "📋",
    title: "Pilih Produk",
    desc: "Cek daftar produk kami di atas. Tentukan jenis potongan dan jumlah yang Anda inginkan.",
  },
  {
    number: "02",
    icon: "💬",
    title: "Chat via WhatsApp",
    desc: "Hubungi kami langsung via WhatsApp. Ceritakan pesanan Anda, kami akan konfirmasi ketersediaan.",
  },
  {
    number: "03",
    icon: "💳",
    title: "Konfirmasi & Bayar",
    desc: "Kami infokan total harga. Pembayaran bisa transfer bank atau tunai saat pengambilan/antar.",
  },
  {
    number: "04",
    icon: "🚚",
      ...
      <div className="relative max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {steps.map((s, i) => (
            <div
              key={i}
              className="group relative overflow-hidden rounded-3xl p-6 bg-white dark:bg-[#1e1e1e] border border-stone-200 dark:border-[#2e2e2e] hover:-translate-y-2 hover:border-[#c9a84c] dark:hover:border-[#c9a84c] hover:shadow-xl hover:shadow-black/8 dark:hover:shadow-black/40 transition-all duration-300"
            >
              ...
              <div className="w-14 h-14 rounded-2xl mb-5 flex items-center justify-center text-3xl bg-red-50 dark:bg-[#b91c1c]/10 border border-red-100 dark:border-[#b91c1c]/20 group-hover:bg-red-100 dark:group-hover:bg-[#b91c1c]/20 transition-colors duration-300">
                {s.icon}
              </div>
        ...
        {/* ══ DELIVERY SECTION ══ */}
        <div className="mb-16 overflow-hidden rounded-3xl bg-white dark:bg-[#1e1e1e] border border-stone-200 dark:border-[#2e2e2e] md:flex">
          {/* Image */}
        ...
        <div className="text-center">
          <a
            ...
            className="inline-flex items-center gap-3 bg-red-700 hover:bg-red-800 text-white text-lg font-bold px-10 py-5 rounded-full transition-all duration-300 hover:scale-105 shadow-xl shadow-red-700/20 dark:shadow-[#b91c1c]/30"
          >
