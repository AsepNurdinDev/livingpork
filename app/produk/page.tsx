    ...
    <main className="bg-[#f8f6f2] dark:bg-[#111110] text-stone-900 dark:text-[#fbf7f0] pt-20 min-h-screen transition-colors duration-300">
      ...
      <div className="bg-[#f8f6f2] dark:bg-[#111110] px-6 pt-10 pb-6 transition-colors duration-300">
        <div className="max-w-6xl mx-auto">
          ...
          <h1 className="text-4xl md:text-5xl font-serif font-black text-stone-900 dark:text-[#fbf7f0] leading-tight">
        ...
        <div className="max-w-6xl mx-auto px-4 py-3 flex flex-col sm:flex-row sm:items-center gap-3">
          ...
          <div className="relative w-full sm:w-56 shrink-0">
            ...
            <input
              ...
              className="w-full pl-9 pr-4 py-2 rounded-full text-sm bg-white dark:bg-[#1e1e1e] border border-stone-200 dark:border-[#2e2e2e] text-stone-700 dark:text-[#fbf7f0] placeholder-stone-400 dark:placeholder-[#555] focus:outline-none focus:border-[#c9a84c] dark:focus:border-[#c9a84c] transition-colors duration-200"
            />
          </div>
        </div>
      </div>
                    ...
                    <div className="flex flex-col flex-1 p-6">
                      ...
                      <div className="flex flex-wrap gap-1.5 mt-4">
                        {p.cookingSuggestions.slice(0, 3).map((s, j) => (
                          <span
                            key={j}
                            className="text-[10px] px-2 py-0.5 rounded-full bg-stone-100 dark:bg-[#252521] text-stone-500 dark:text-[#a8a29e] border border-stone-200 dark:border-[#333]"
                          >
                            {s}
                          </span>
                        ))}
                      ...
                      <div className="mt-5 flex items-end justify-between">
                        ...
                        >
                          <span
                            className={`w-1.5 h-1.5 rounded-full ${p.inStock ? "bg-green-500 animate-pulse" : "bg-red-500"}`}
                          />
                      ...
                      <div className="mt-4 flex gap-2">
                        ...
                        <a
                          href={`https://wa.me/${WA_NUMBER}?text=${encodeURIComponent(
                            `Halo Living Pork, saya mau pesan ${p.name}. Apakah stok tersedia?`,
                          )}`}
                          target="_blank"
        ...
        <FadeIn>
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-stone-500 dark:text-[#a8a29e] text-sm leading-relaxed mb-8">
              Kami menyediakan layanan custom cutting sesuai spesifikasi Anda.
              Hubungi kami untuk informasi lebih lanjut.
            </p>

            <a
              href={`https://wa.me/${WA_NUMBER}?text=${encodeURIComponent(
                "Halo Living Pork, saya ingin menanyakan produk atau potongan khusus.",
              )}`}
              target="_blank"
              rel="noopener noreferrer"
